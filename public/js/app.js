...
__webpack_require__(/*! ./custom/menu */ "./resources/js/custom/menu.js");
...
var forEach = __webpack_require__(/*! lodash/forEach */ "./node_modules/lodash/forEach.js"); // Add Event on every Menu


var menu_items = document.querySelectorAll('#parent-menu-ul li');
forEach(menu_items, function (menu) {
...
function setActive(menu_id) {
  // Set Inactive menu
  var active_menu = document.querySelectorAll(".active");
  ...
  document.getElementById(menu_id).classList.add('active'); // Display Content

  var visible_content = document.querySelectorAll(".visible"); // Hide visible content

  visible_content[0].classList.remove('visible');
  visible_content[0].classList.add('hidden'); // Display Selected Menu
